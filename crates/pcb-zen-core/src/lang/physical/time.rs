...
starlark_simple_value!(TimeType);
...
impl<'a> PhysicalUnitType<'a> for TimeType {
    const UNIT: PhysicalUnit = PhysicalUnit::Time;
}
...
#[starlark_value(type = "TimeType")]
impl<'v> StarlarkValue<'v> for TimeType {
    fn invoke(
        &self,
        _me: Value<'v>,
        args: &Arguments<'v, '_>,
