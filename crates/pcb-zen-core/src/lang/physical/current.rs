...
starlark_simple_value!(CurrentType);
...
impl<'a> PhysicalUnitType<'a> for CurrentType {
    const UNIT: PhysicalUnit = PhysicalUnit::Current;
}
...
#[starlark_value(type = "CurrentType")]
impl<'v> StarlarkValue<'v> for CurrentType {
    fn invoke(
        &self,
        _me: Value<'v>,
        args: &Arguments<'v, '_>,
