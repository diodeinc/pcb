...
fn main() -> Result<()> {
    ...
    let BoardArrayBalancingCollection {
        ...
        board_instance_count: board_instances,
        support_layers: support_geometry,
    } = collection;
    let support_layers = support_sources
        .into_iter()
        .zip(support_geometry)
        .map(|(source, geometry)| support_layer(source, geometry))
        .collect::<Vec<_>>();
...
fn write_artifacts(
    ...
    let stages = [
        ...
        Stage {
            ...
            title: "30 — all painted ArraySupport feature footprints",
