...
See [Packages](/pages/packages) for version resolution, KiCad library
configuration, and dependency commands.
...
Older workspace formats are no longer supported. If you have an older project,
run `pcb migrate` to upgrade manifests and import paths.
