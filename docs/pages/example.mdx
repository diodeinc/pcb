...
```
[!TIP] There are other defineable fields in the component, [check out the spec](https://docs.pcb.new/pages/spec#component)!
...
```zener
antenna_symbol = Symbol("@kicad-symbols/Device.kicad_sym:Antenna")
