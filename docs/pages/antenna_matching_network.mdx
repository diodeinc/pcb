...
CENTER = io("CENTER", Net, help="Coax center conductor", direction="output")
SHIELD = io("SHIELD", Ground, help="Coax shield", direction="output")
...
FEED = io("FEED", Net, direction="input")
...
RF_IN = io("RF_IN", Net, direction="input")
RF_OUT = io("RF_OUT", Net, direction="output")
GND = io("GND", Ground, direction="input")
MATCH_NODE = Net()
