...
```
<Warning> In the future, variables may not be able to use symbols, so you should define symbols inline when defining components, as shown later in this tutorial. </Warning>
...
## Complete the Antenna Matching Network
Let's first import our custom modules into our `EX0001.zen`:
