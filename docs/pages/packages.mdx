...
```
github.com/acme/component-lib v0.3.2 h1:sL5Wum7w69ati4f0ExSvRMgfk8kD8MoW0neD6yS94Yo=
github.com/acme/component-lib v0.3.2/pcb.toml h1:abc123def456...
...
Runs project migrations when a release provides them. The command is currently kept
as a stable entry point, but this release does not include legacy V1 manifest or
import-path migrations.

```bash
pcb migrate                  # Run available migrations, if any
