...
- `pcb route` runs FreeRouting v2.0.1 headlessly on the local machine with auto-download, SHA-256 verification, trace clearing, and board backup. Cloud routing (`--remote`) is hidden from help.
