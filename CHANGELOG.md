...
- Place hierarchy-related net symbols through the regular component-driver path, and offset hierarchy bridge labels with orthogonal routes instead of stacking either directly on connection points.
