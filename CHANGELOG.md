...
- Stop piling mouse-bite tabs onto a board when part of its outline is out of reach of every tab.
...
- Speed up workspace discovery, dependency resolution and `pcb info` in large workspaces.
...
- Keep children of an id registered as both a module and a leaf component in the hierarchical layout output.
