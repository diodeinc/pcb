...
- `Component()` now inherits default `part` and `alternatives` from manifest `parts` entries matched by stable `package://` symbol URIs.
...
[Unreleased]: https://github.com/diodeinc/pcb/compare/v0.3.52...HEAD
