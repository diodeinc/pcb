...
- Improve schematic generation and reconciliation with compact grid placement, grouped patterns, page fitting, KiCad-style hierarchy and fields, and shared orthogonal routing.
