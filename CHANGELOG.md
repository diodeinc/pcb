...
- Gerber exports coalesce compatible step-repeat blocks and omit unchanged modal coordinate axes for smaller, faster-to-import files.
...
[Unreleased]: https://github.com/diodeinc/pcb/compare/v0.4.27...HEAD
