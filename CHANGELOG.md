...
- `pcb route-local` runs FreeRouting v2.0.1 headlessly on the local machine with auto-download, SHA-256 verification, Java 21+ auto-provisioning, trace clearing, and board backup. Cloud routing via DeepPCB is in `pcb route` (hidden).
