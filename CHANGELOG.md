...
- Place generated schematic net symbols outside full component geometry in deterministic wired staircases, sharing one symbol across same-net pins on one component side and reserving the routed staircase during component packing.
