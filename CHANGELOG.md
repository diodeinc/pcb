...
- Linux `pcb-launcher --install` now treats desktop-database and MIME registration tool failures as best-effort so a partial desktop environment no longer aborts `pcb` install.
