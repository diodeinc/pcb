...
Prefer generic choices when technically valid and leave part selection to the BOM API. If rounding, clamping, or substituting values, document why; use an explicit part only when the design requires one.
